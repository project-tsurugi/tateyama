...
set(disabled_sanitizers "alignment")
if(ENABLE_UB_SANITIZER)
    # NOTE: UB check requires instrumented libstdc++
    set(sanitizers "${sanitizers},undefined")
    set(disabled_sanitizers "${disabled_sanitizers},vptr") # vptr check cause error with dlopen
endif()
...
if(ENABLE_SANITIZER)
    ...
    set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -fno-sanitize=${disabled_sanitizers}")
