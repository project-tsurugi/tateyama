...
| default_partitions | Integer | Number of partitions when data is divided for parallelizable relational operators. The default value is 5. | The value must be less than max_result_set_writers |
...
|scan_default_parallel| Integer | Maximum Degree of Parallelism for Scan Tasks. The default is 4. | This value must be less than the value of default_partitions and max_result_set_writers. This is for development and may be deleted in the future. |
