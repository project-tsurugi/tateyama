...
|dev_enable_truncate| Boolean (true/false) | Whether to support TRUNCATE TABLE statement. Default is `true`. | This is for development and may be deleted in the future. |
