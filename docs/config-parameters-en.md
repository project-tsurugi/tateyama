...
|scan_default_parallel| Integer | Maximum Degree of Parallelism for Scan Tasks. The default is 1. | This value must be less than the value of default_partitions. This is for development and may be deleted in the future. |
