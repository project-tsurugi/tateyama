...
public:
     ...
     */
    virtual std::optional<std::string> verify_token(std::string_view token) const = 0;
     ...
     */
    virtual std::optional<std::string> verify_encrypted(std::string_view username, std::string_view password) const = 0;
     ...
     */
    virtual std::optional<encryption_key_type> get_encryption_key() const = 0;
