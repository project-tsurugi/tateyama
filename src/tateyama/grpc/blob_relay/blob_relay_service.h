...
class blob_relay_helper : public tateyama::grpc::server::grpc_service_handler {
public:
    blob_relay_helper(::limestone::api::datastore& datastore, ::tateyama::framework::environment& env) :
