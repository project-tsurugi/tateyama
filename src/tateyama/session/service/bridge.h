...
public:
    static constexpr id_type tag = framework::service_id_session;

    [[nodiscard]] id_type id() const noexcept override;

    //@brief human readable label of this component
    static constexpr std::string_view component_label = "session_service";
...
private:
    std::unique_ptr<tateyama::session::service::core> core_{};
